...
'''
Python3, entry point to request the thermostat turn the fan on. See Readme for reference use with Apache or NginX
...
def main():
    ...
    try:
        _module_logger.info('Attempting to turn fan on')
        nest_utils.set_fan()
        print('ACK')
